...
const Home = () => {
  return (
    <div className="container mx-auto px-5 pt-5 md:pt-16 lg:pt-24">
      {/* Hero Section */}
      <div className="grid grid-cols-1 align-middle grid-rows-1 md:grid-cols-2 md:gap-x-10 lg:grid-rows-4">
        <div className="relative col-span-1 row-span-1 grid place-content-end text-center md:text-left lg:row-span-3 lg:place-items-end">
          ...
          <h3 className="bg-gradient-to-r mx-auto  from-cyan-300 via-purple-500 to-blue-500 bg-clip-text text-2xl font-bold text-transparent md:text-4xl lg:text-6xl">
            DaedaVote
          </h3>
