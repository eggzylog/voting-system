...
export const RegisterNeed = () => {
  return (
    <div className="mx col-span-2 mx-3 mt-16 rounded-2xl border-background-lighter bg-[#2020537e] p-3 text-center outline outline-2 outline-[#7979c436] sm:p-4 md:col-start-2 md:mx-0 md:p-5 lg:col-start-3 lg:mt-20 lg:p-8">
