  ...
  return (
    <>
      <div className="col-span-1 grid w-full grid-cols-3 grid-rows-3 gap-x-5 rounded-2xl border-background-lighter bg-[#2020537e] p-3 text-white  outline outline-2 outline-[#7979c436]">
        ...
        />
        <h1 className="col-span-2 row-span-1 bg-gradient-to-r from-cyan-300 via-purple-500 to-blue-500 bg-clip-text text-xl font-bold text-transparent md:text-2xl lg:text-3xl">
